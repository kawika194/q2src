...
*/
	{
		...
		Weapon_HyperBlaster,
		"misc/w_pkup.wav",
	//	"models/items/ammo/grenades/medium/tris.md2", 0,		//first one is map look
	//	"models/weapons/v_handgr/tris.md2",						//2nd one is in hand look
		"models/weapons/g_hyperb/tris.md2", EF_ROTATE,			//if i keep initial hyperblaster and
		"models/weapons/v_handgr/tris.md2",						//have 2nd one be grenade, itll look like grenade in hand
